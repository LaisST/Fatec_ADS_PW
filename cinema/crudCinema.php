...
switch($acao){
    ...
    case 'formInserir':
        ...
        <tr >
        <td width='118'>
        <font size='2' face='Verdana, Arial, Helvetica, sans-serif' >ID DO CINEMA:</font>
        </td>
        <td width='460'>
        ...
        <option value='3'>MOGI DAS CRUZES</option>
        <option value='4'>FERRAZ DE VASCONCELOS</option>
    ...
    case 'inserir':
        ...
        $sqlInsert = "INSERT INTO Cinemas (IdCinema, NomeCinema, Rua, Numero, CEP, IdCidade) 
        values ('$id', '$nome', '$rua', '$numero', '$cep', $IdCidade)";
    ...
    case 'selecionar':
       ...
       echo "<th><a style='margin: 10px;'>AÇÃO</a></th>";
        ...
        $sqlSelect = "SELECT * , Municipios.Cidade, Municipios.UF  FROM Cinemas inner join Municipios on (Cinemas.IdCidade = Municipios.IdCidade) ";
