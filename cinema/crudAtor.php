...
<body>
    ...
    <?php
        ...
        case 'formInserir':
            ...
            <tr>
            <tr>
            <td width='118'><font size='2' face='Verdana, Arial, Helvetica, sans=serif'> GÊNERO: </font></td>
            <td width='460'>
            <font size='2'>
        ...
        case 'inserir':
            ...
            $sqlInsert = "INSERT INTO Atores (Nome, Sexo, DataNascimento) 
            values ('$nome', '$sexo', '$data')";
        ...
        echo "<center><table width='588' border='0' >";
         ...
         while ($registro = mysqli_fetch_array($resultado)){
            ...
            echo "<font size='2'>
                <select name='sexo' id='sexo'>
                <option value='" . htmlspecialchars($registro['Sexo']) . "'  selected>" . htmlspecialchars($registro['Sexo']) . "</option>
                <option value='FEMININO'>FEMININO</option>
                <option value='MASCULINO'>MASCULINO</option>
                <option value='TRANSGENERO'>TRANSGÊNERO</option>
                <option value='NEUTRO'>NEUTRO</option>
    ...
    #//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        case 'selecionar':
            ...
            $sqlSelect = "SELECT * FROM Atores order by Nome";
